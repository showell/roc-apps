...
Ground :: [].{
	...
	ground_verts = |ps, i| (if (i >= U64.to_i64_wrap(List.len(ps))) { [] } else { List.concat([ground_vert((List.get(ps, I64.to_u64_wrap(i)) ?? crash("list-at out of range")))], ground_verts(ps, (i + 1))) })
