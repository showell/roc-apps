# DeviceMath -- originally emitted from Codex by rocemit; the Roc is the program now
...
DeviceMath :: [].{
	...
	dm_quarter_pi : F64
	dm_quarter_pi = 0.785398163397448

	dm_three_quarter_pi : F64
	dm_three_quarter_pi = 2.356194490192345
	...
	dm_atan_half_step : F64 -> F64
	dm_atan_half_step = |t| (t / (1.0 + real_sqrt((1.0 + (t * t)))))

	dm_atan_halve : F64, I64 -> F64
	dm_atan_halve = |t, n| (if (n <= 0) { t } else { dm_atan_halve(dm_atan_half_step(t), (n - 1)) })
