# forewords@foreword-scheduler
#
# Ported from Cobblestone's Codex test suite, not written for Roc.
#
#   from      https://github.com/damiant3/Cobblestone/blob/master/codex/test/forewords@foreword-scheduler.codex
...
# FwdSchedulerTest -- emitted from Codex by rocemit (rust-codex-compiler). Do not edit.
...
main! = |_args| {
	line!(Text.printed([54, 16, 21, 13, 27, 16, 21, 22, 81, 45, 24, 20, 13, 22, 25, 23, 13, 21, 2, 42, 60]))
	Ok({})
}
