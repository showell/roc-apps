# forewords@engine-soft-body
#
# Ported from Cobblestone's Codex test suite, not written for Roc.
#
#   from      https://github.com/damiant3/Cobblestone/blob/master/codex/test/forewords@engine-soft-body.codex
...
# FwdSoftBodyTest -- emitted from Codex by rocemit (rust-codex-compiler). Do not edit.
...
main! = |_args| {
	line!(Text.printed([39, 18, 29, 17, 18, 13, 81, 45, 16, 28, 14, 58, 16, 22, 30, 2, 42, 60]))
	Ok({})
}
