# forewords@sim-steering
#
# Ported from Cobblestone's Codex test suite, not written for Roc.
#
#   from      https://github.com/damiant3/Cobblestone/blob/master/codex/test/forewords@sim-steering.codex
...
# FwdSteeringTest -- emitted from Codex by rocemit (rust-codex-compiler). Do not edit.
...
main! = |_args| {
	line!(Text.printed([45, 17, 26, 81, 45, 14, 13, 13, 21, 17, 18, 29, 2, 42, 60]))
	Ok({})
}
