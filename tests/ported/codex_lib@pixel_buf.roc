...
row! : Mem.Mem, PixelBuf.GopBuf, I64 => (Mem.Mem, Text)
row! = |mem, gb, y| row_loop!(mem, gb, y, 0, "")

row_loop! : Mem.Mem, PixelBuf.GopBuf, I64, I64, Text => (Mem.Mem, Text)
row_loop! = |mem, gb, y, x, acc| (if (x >= 8) { (mem, acc) } else { ({
	...
	row_loop!(mem1, gb, y, (x + 1), Text.concat(acc, c))
}) })

grid! : Mem.Mem, PixelBuf.GopBuf => (Mem.Mem, Text)
grid! = |mem, gb| ({
	(mem5, mem__1) = ({
	(mem1, a) = row!(mem, gb, 0)
	...
	(mem4, Text.concat(Text.concat(Text.concat(Text.concat(Text.concat(Text.concat(a, "/"), b), "/"), c), "/"), d))
})
	(mem5, mem__1)
})

line_new! : Mem.Mem => (Mem.Mem, Text)
line_new! = |mem| ({
	(mem3, mem__2) = ({
	(mem1, gb) = PixelBuf.gop_buf_new!(mem, 8, 4, 0)
	({
		(mem2, mem__1) = grid!(mem1, gb)
		(mem2, Text.concat("new: ", mem__1))
	})
})
	(mem3, mem__2)
})

line_set! : Mem.Mem => (Mem.Mem, Text)
line_set! = |mem| ({
	(mem5, mem__2) = ({
	(mem1, gb) = PixelBuf.gop_buf_new!(mem, 8, 4, 0)
	...
	({
		...
		(mem4, Text.concat("set: ", mem__1))
	})
})
	(mem5, mem__2)
})

line_clip! : Mem.Mem => (Mem.Mem, Text)
line_clip! = |mem| ({
	(mem8, mem__2) = ({
	(mem1, gb) = PixelBuf.gop_buf_new!(mem, 8, 4, 0)
	...
	({
		...
		(mem7, Text.concat("clip: ", mem__1))
	})
})
	(mem8, mem__2)
})

line_clip_read! : Mem.Mem => (Mem.Mem, Text)
line_clip_read! = |mem| ({
	(mem6, mem__4) = ({
	(mem1, gb) = PixelBuf.gop_buf_new!(mem, 8, 4, 0)
	...
	(mem5, Text.concat(Text.concat(Text.concat(Text.concat(Text.concat("clip read: left=", a), " right="), b), " inside="), c))
})
	(mem6, mem__4)
})

line_rect! : Mem.Mem => (Mem.Mem, Text)
line_rect! = |mem| ({
	(mem4, mem__2) = ({
	(mem1, gb) = PixelBuf.gop_buf_new!(mem, 8, 4, 0)
	...
	({
		...
		(mem3, Text.concat("rect: ", mem__1))
	})
})
	(mem4, mem__2)
})

line_hline! : Mem.Mem => (Mem.Mem, Text)
line_hline! = |mem| ({
	(mem4, mem__2) = ({
	(mem1, gb) = PixelBuf.gop_buf_new!(mem, 8, 4, 0)
	...
	({
		(mem3, mem__1) = grid!(mem2, gb)
		(mem3, Text.concat("hline: ", mem__1))
	})
})
	(mem4, mem__2)
})

line_vline! : Mem.Mem => (Mem.Mem, Text)
line_vline! = |mem| ({
	(mem4, mem__2) = ({
	(mem1, gb) = PixelBuf.gop_buf_new!(mem, 8, 4, 0)
	...
	({
		(mem3, mem__1) = grid!(mem2, gb)
		(mem3, Text.concat("vline: ", mem__1))
	})
})
	(mem4, mem__2)
})

line_outline! : Mem.Mem => (Mem.Mem, Text)
line_outline! = |mem| ({
	(mem4, mem__2) = ({
	(mem1, gb) = PixelBuf.gop_buf_new!(mem, 8, 4, 0)
	...
	({
		(mem3, mem__1) = grid!(mem2, gb)
		(mem3, Text.concat("outline: ", mem__1))
	})
})
	(mem4, mem__2)
})

blended! : Mem.Mem, I64 => (Mem.Mem, Text)
blended! = |mem, alpha| ({
	(mem5, mem__2) = ({
	(mem1, gb) = PixelBuf.gop_buf_new!(mem, 8, 4, 0)
...
line_blend! : Mem.Mem => (Mem.Mem, Text)
line_blend! = |mem| ({
	(mem6, mem__1) = ({
	...
	(mem5, Text.concat(Text.concat(Text.concat(Text.concat(Text.concat(Text.concat(Text.concat(Text.concat(Text.concat("blend: a0=", a), " a128="), b), " a239="), c), " a240="), d), " a255="), e))
})
	(mem6, mem__1)
})
...
line_cost! : Mem.Mem => (Mem.Mem, Text)
line_cost! = |mem| ({
	(mem7, mem__1) = ({
	(mem1, gb) = PixelBuf.gop_buf_new!(mem, 8, 4, 0)
	...
	(mem6, Text.concat(Text.concat(Text.concat("cost: control=", Text.show_int((c1 - c0))), " thousand-writes="), Text.show_int((w1 - w0))))
})
	(mem7, mem__1)
})

report_a! : Mem.Mem => (Mem.Mem, Text)
report_a! = |mem| ({
	(mem1, mem__1) = line_new!(mem)
	(mem2, mem__2) = line_set!(mem1)
	(mem3, mem__3) = line_clip!(mem2)
	(mem4, mem__4) = line_clip_read!(mem3)
	(mem4, Text.concat(Text.concat(Text.concat(Text.concat(Text.concat(Text.concat(mem__1, "\n"), mem__2), "\n"), mem__3), "\n"), mem__4))
})

report_b! : Mem.Mem => (Mem.Mem, Text)
report_b! = |mem| ({
...
report_c! : Mem.Mem => (Mem.Mem, Text)
report_c! = |mem| ({
	(mem1, mem__1) = line_blend!(mem)
	(mem2, mem__2) = line_cost!(mem1)
	(mem2, Text.concat(Text.concat(mem__1, "\n"), mem__2))
})
