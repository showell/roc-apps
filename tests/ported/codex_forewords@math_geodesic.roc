# forewords@math-geodesic
#
# Ported from Cobblestone's Codex test suite, not written for Roc.
#
#   from      https://github.com/damiant3/Cobblestone/blob/master/codex/test/forewords@math-geodesic.codex
...
# FwdGeodesicTest -- emitted from Codex by rocemit (rust-codex-compiler). Do not edit.
...
main! = |_args| {
	line!(CceText.printed("Math/Geodesic OK"))
	Ok({})
}
