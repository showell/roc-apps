...
#
#   from      https://github.com/damiant3/Cobblestone/blob/master/codex/test/roc-fold-empty.codex
...
# RocFoldEmpty -- emitted from Codex by rocemit (rust-codex-compiler). Do not edit.
