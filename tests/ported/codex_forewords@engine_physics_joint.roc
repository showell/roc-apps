# forewords@engine-physics-joint
#
# Ported from Cobblestone's Codex test suite, not written for Roc.
#
#   from      https://github.com/damiant3/Cobblestone/blob/master/codex/test/forewords@engine-physics-joint.codex
...
# FwdPhysicsJointTest -- emitted from Codex by rocemit (rust-codex-compiler). Do not edit.
...
main! = |_args| {
	line!(Text.printed([39, 18, 29, 17, 18, 13, 81, 57, 20, 30, 19, 17, 24, 19, 61, 16, 17, 18, 14, 2, 42, 60]))
	Ok({})
}
