...
main! = |_args| {
	line!(Text.printed(Text.concat("view:", read_all(tail_of([1, 2, 3, 4])))))
	line!(Text.printed(Text.concat("view-len=", Text.show_int(U64.to_i64_wrap(List.len(tail_of([1, 2, 3, 4])))))))
	Ok({})
}
