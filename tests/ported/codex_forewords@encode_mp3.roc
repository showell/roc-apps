# forewords@encode-mp3
#
# Ported from Cobblestone's Codex test suite, not written for Roc.
#
#   from      https://github.com/damiant3/Cobblestone/blob/master/codex/test/forewords@encode-mp3.codex
...
# FwdMp3Test -- emitted from Codex by rocemit (rust-codex-compiler). Do not edit.
...
main! = |_args| {
	line!(Text.printed([39, 18, 24, 16, 22, 13, 81, 52, 31, 6, 2, 42, 60]))
	Ok({})
}
