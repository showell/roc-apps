# forewords@signal-synth
#
# Ported from Cobblestone's Codex test suite, not written for Roc.
#
#   from      https://github.com/damiant3/Cobblestone/blob/master/codex/test/forewords@signal-synth.codex
...
# FwdSynthTest -- emitted from Codex by rocemit (rust-codex-compiler). Do not edit.
...
main! = |_args| {
	line!(Text.printed([45, 17, 29, 18, 15, 23, 81, 45, 30, 18, 14, 20, 2, 42, 60]))
	Ok({})
}
