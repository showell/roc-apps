...
Ethernet :: [].{
	...
	arp_parse = |payload| (if (U64.to_i64_wrap(List.len(payload)) < 28) { Ethernet.ArpPacket.{ op: 1, sender_mac: [0, 0, 0, 0, 0, 0], sender_ip: [0, 0, 0, 0], target_mac: [0, 0, 0, 0, 0, 0], target_ip: [0, 0, 0, 0] } } else { Ethernet.ArpPacket.{ op: read_be16(payload, 6), sender_mac: [(List.get(payload, I64.to_u64_wrap(8)) ?? crash("list-at out of range")), (List.get(payload, I64.to_u64_wrap(9)) ?? crash("list-at out of range")), (List.get(payload, I64.to_u64_wrap(10)) ?? crash("list-at out of range")), (List.get(payload, I64.to_u64_wrap(11)) ?? crash("list-at out of range")), (List.get(payload, I64.to_u64_wrap(12)) ?? crash("list-at out of range")), (List.get(payload, I64.to_u64_wrap(13)) ?? crash("list-at out of range"))], sender_ip: [(List.get(payload, I64.to_u64_wrap(14)) ?? crash("list-at out of range")), (List.get(payload, I64.to_u64_wrap(15)) ?? crash("list-at out of range")), (List.get(payload, I64.to_u64_wrap(16)) ?? crash("list-at out of range")), (List.get(payload, I64.to_u64_wrap(17)) ?? crash("list-at out of range"))], target_mac: [(List.get(payload, I64.to_u64_wrap(18)) ?? crash("list-at out of range")), (List.get(payload, I64.to_u64_wrap(19)) ?? crash("list-at out of range")), (List.get(payload, I64.to_u64_wrap(20)) ?? crash("list-at out of range")), (List.get(payload, I64.to_u64_wrap(21)) ?? crash("list-at out of range")), (List.get(payload, I64.to_u64_wrap(22)) ?? crash("list-at out of range")), (List.get(payload, I64.to_u64_wrap(23)) ?? crash("list-at out of range"))], target_ip: [(List.get(payload, I64.to_u64_wrap(24)) ?? crash("list-at out of range")), (List.get(payload, I64.to_u64_wrap(25)) ?? crash("list-at out of range")), (List.get(payload, I64.to_u64_wrap(26)) ?? crash("list-at out of range")), (List.get(payload, I64.to_u64_wrap(27)) ?? crash("list-at out of range"))] } })
