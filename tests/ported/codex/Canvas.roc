...
Canvas :: [].{
	...
	viewport_new = |cx, cy, cw, ch| { vp_pan_x: 0, vp_pan_y: 0, vp_zoom: 100, vp_grid: 20, vp_canvas_x: cx, vp_canvas_y: cy, vp_canvas_w: cw, vp_canvas_h: ch }

	viewport_pan : Canvas.ViewPort, I64, I64 -> Canvas.ViewPort
	viewport_pan = |vp, dx, dy| { vp_pan_x: (vp.vp_pan_x + dx), vp_pan_y: (vp.vp_pan_y + dy), vp_zoom: vp.vp_zoom, vp_grid: vp.vp_grid, vp_canvas_x: vp.vp_canvas_x, vp_canvas_y: vp.vp_canvas_y, vp_canvas_w: vp.vp_canvas_w, vp_canvas_h: vp.vp_canvas_h }
	...
	viewport_zoom_in = |vp| ({
		...
		{ vp_pan_x: vp.vp_pan_x, vp_pan_y: vp.vp_pan_y, vp_zoom: clamped, vp_grid: vp.vp_grid, vp_canvas_x: vp.vp_canvas_x, vp_canvas_y: vp.vp_canvas_y, vp_canvas_w: vp.vp_canvas_w, vp_canvas_h: vp.vp_canvas_h }
	})
	...
	viewport_zoom_fit = |vp| { vp_pan_x: 0, vp_pan_y: 0, vp_zoom: 100, vp_grid: vp.vp_grid, vp_canvas_x: vp.vp_canvas_x, vp_canvas_y: vp.vp_canvas_y, vp_canvas_w: vp.vp_canvas_w, vp_canvas_h: vp.vp_canvas_h }
	...
	vp_set_canvas = |vp, cx, cy, cw, ch| { vp_pan_x: vp.vp_pan_x, vp_pan_y: vp.vp_pan_y, vp_zoom: vp.vp_zoom, vp_grid: vp.vp_grid, vp_canvas_x: cx, vp_canvas_y: cy, vp_canvas_w: cw, vp_canvas_h: ch }
}
