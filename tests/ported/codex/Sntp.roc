...
Sntp :: [].{
	...
	sntp_flags = |li, version, mode| I64.bitwise_or(I64.bitwise_or(I64.shl_wrap(li, I64.to_u8_wrap(6)), I64.shl_wrap(version, I64.to_u8_wrap(3))), mode)
	...
	sntp_u32_be = |v| [I64.bitwise_and(I64.shr_zf_wrap(v, I64.to_u8_wrap(24)), 255), I64.bitwise_and(I64.shr_zf_wrap(v, I64.to_u8_wrap(16)), 255), I64.bitwise_and(I64.shr_zf_wrap(v, I64.to_u8_wrap(8)), 255), I64.bitwise_and(v, 255)]

	sntp_read_u32_be : List(I64), I64 -> I64
	sntp_read_u32_be = |packet, off| I64.bitwise_or(I64.bitwise_or(I64.bitwise_or(I64.shl_wrap((List.get(packet, I64.to_u64_wrap(off)) ?? crash("list-at out of range")), I64.to_u8_wrap(24)), I64.shl_wrap((List.get(packet, I64.to_u64_wrap((off + 1))) ?? crash("list-at out of range")), I64.to_u8_wrap(16))), I64.shl_wrap((List.get(packet, I64.to_u64_wrap((off + 2))) ?? crash("list-at out of range")), I64.to_u8_wrap(8))), (List.get(packet, I64.to_u64_wrap((off + 3))) ?? crash("list-at out of range")))
	...
	sntp_version = |packet| I64.bitwise_and(I64.shr_zf_wrap((List.get(packet, I64.to_u64_wrap(0)) ?? crash("list-at out of range")), I64.to_u8_wrap(3)), 7)
