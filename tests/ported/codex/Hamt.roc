...
Hamt :: [].{
	...
	hamt_djb2_hash : CceText -> I64
	hamt_djb2_hash = |s| hamt_djb2_loop(s, 0, CceText.len(s), 5381)

	hamt_djb2_loop : CceText, I64, I64, I64 -> I64
	hamt_djb2_loop = |s, i, len, h| (if (i == len) { abs_int(h) } else { hamt_djb2_loop(s, (i + 1), len, I64.plus_wrap(I64.times_wrap(h, 33), CceChar.code(CceText.char_at(s, i)))) })
	...
	hamt_node_get : Hamt.HamtNode(a), I64, CceText, I64 -> Maybe.Maybe(a)
	...
	collision_find : List(Hamt.HamtEntry(a)), CceText -> Maybe.Maybe(a)
	...
	hamt_node_set : Hamt.HamtNode(a), I64, CceText, a, I64 -> Hamt.HamtSetResult(a)
	...
	collision_set : List(Hamt.HamtEntry(a)), CceText, a -> Hamt.CollisionSetResult(a)
	collision_set = |entries, key, value| collision_set_loop(entries, key, value, 0)

	collision_set_loop : List(Hamt.HamtEntry(a)), CceText, a, I64 -> Hamt.CollisionSetResult(a)
	...
	hamt_node_remove : Hamt.HamtNode(a), I64, CceText, I64 -> Maybe.Maybe(Hamt.HamtNode(a))
	...
	collision_remove : List(Hamt.HamtEntry(a)), CceText -> List(Hamt.HamtEntry(a))
	collision_remove = |entries, key| collision_remove_acc(entries, key, [])

	collision_remove_acc : List(Hamt.HamtEntry(a)), CceText, List(Hamt.HamtEntry(a)) -> List(Hamt.HamtEntry(a))
	...
	hamt_contains : Hamt.HamtMap(a), CceText -> Bool
	...
	hamt_fold : (a, CceText, b -> a), a, Hamt.HamtMap(b) -> a
	hamt_fold = |f, init, m| hamt_node_fold(f, init, m.root)

	hamt_node_fold : (a, CceText, b -> a), a, Hamt.HamtNode(b) -> a
	...
	fold_entries : (a, CceText, b -> a), a, List(Hamt.HamtEntry(b)), I64 -> a
	...
	fold_children : (a, CceText, b -> a), a, List(Hamt.HamtNode(b)), I64 -> a
	...
	lam_0 : List(Hamt.HamtEntry(a)), CceText, a -> List(Hamt.HamtEntry(a))
