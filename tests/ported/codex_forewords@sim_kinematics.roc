# forewords@sim-kinematics
#
# Ported from Cobblestone's Codex test suite, not written for Roc.
#
#   from      https://github.com/damiant3/Cobblestone/blob/master/codex/test/forewords@sim-kinematics.codex
...
# FwdKinematicsTest -- emitted from Codex by rocemit (rust-codex-compiler). Do not edit.
...
main! = |_args| {
	line!(Text.printed([45, 17, 26, 81, 60, 17, 18, 13, 26, 15, 14, 17, 24, 19, 2, 42, 60]))
	Ok({})
}
