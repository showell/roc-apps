# forewords@signal-oscillator
#
# Ported from Cobblestone's Codex test suite, not written for Roc.
#
#   from      https://github.com/damiant3/Cobblestone/blob/master/codex/test/forewords@signal-oscillator.codex
...
# FwdOscillatorTest -- emitted from Codex by rocemit (rust-codex-compiler). Do not edit.
...
main! = |_args| {
	line!(CceText.printed("Signal/Oscillator OK"))
	Ok({})
}
