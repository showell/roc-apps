...
cst_key : I64 -> Str
cst_key = |i| Str.concat("key", I64.to_str(i))
...
main! = |_args| {
	...
	line!(Str.concat("keys:           ", I64.to_str(cst_keys)))
	line!(Str.concat("exact:          ", I64.to_str(exact)))
	line!(Str.concat("worst estimate: ", I64.to_str(worst)))
	line!(Str.concat(Str.concat(Str.concat(Str.concat(Str.concat(Str.concat(Str.concat("cols used:      ", I64.to_str(r0)), " "), I64.to_str(r1)), " "), I64.to_str(r2)), " "), I64.to_str(r3)))
	line!(Str.concat("mostly exact:   ", (if ((exact * 4) >= (cst_keys * 3)) { "True" } else { "False" })))
	line!(Str.concat("rows spread:    ", (if ((((r0 > 20) and (r1 > 20)) and (r2 > 20)) and (r3 > 20)) { "True" } else { "False" })))
	line!(Str.concat("total:          ", I64.to_str(CountMinSketch.cms_total(s))))
	Ok({})
}
