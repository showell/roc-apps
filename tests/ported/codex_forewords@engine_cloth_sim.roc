# forewords@engine-cloth-sim
#
# Ported from Cobblestone's Codex test suite, not written for Roc.
#
#   from      https://github.com/damiant3/Cobblestone/blob/master/codex/test/forewords@engine-cloth-sim.codex
...
# FwdClothSimTest -- emitted from Codex by rocemit (rust-codex-compiler). Do not edit.
...
main! = |_args| {
	line!(Text.printed([39, 18, 29, 17, 18, 13, 81, 50, 23, 16, 14, 20, 45, 17, 26, 2, 42, 60]))
	Ok({})
}
