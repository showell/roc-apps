# forewords@engine-musculature
#
# Ported from Cobblestone's Codex test suite, not written for Roc.
#
#   from      https://github.com/damiant3/Cobblestone/blob/master/codex/test/forewords@engine-musculature.codex
...
# FwdMusculatureTest -- emitted from Codex by rocemit (rust-codex-compiler). Do not edit.
...
main! = |_args| {
	line!(Text.printed([39, 18, 29, 17, 18, 13, 81, 52, 25, 19, 24, 25, 23, 15, 14, 25, 21, 13, 2, 42, 60]))
	Ok({})
}
