...
CubemapKernel :: [].{
	...
	cm_pack : F32, F32, F32 -> I32
	cm_pack = |r, g, b| I32.plus_wrap(I32.plus_wrap(I32.times_wrap(F32.to_i32_wrap((cm_clamp01(r) * 255.0)), 65536), I32.times_wrap(F32.to_i32_wrap((cm_clamp01(g) * 255.0)), 256)), F32.to_i32_wrap((cm_clamp01(b) * 255.0)))

	cm_noise : F32, F32 -> F32
	...
	cubemap_step : Device.Device, I32, I32, I32 -> (Device.Device, I32)
