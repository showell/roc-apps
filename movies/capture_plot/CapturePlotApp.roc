# capture_plot on the movie wasm platform: the same movie the roc-ray app
# plays, on a page.
#
# Hand-written, and almost nothing: the platform asks for a model it can step
# and a frame it can draw, and `CapturePlot.movie` is both. Compare
