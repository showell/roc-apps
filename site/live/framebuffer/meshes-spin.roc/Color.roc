...
Color :: [].{
	...
	format_rgb : Color.Rgb -> Str
	format_rgb = |c| Str.concat(Str.concat(Str.concat(Str.concat(Str.concat(Str.concat("rgb(", I64.to_str(c.cr)), ","), I64.to_str(c.cg)), ","), I64.to_str(c.cb)), ")")

	format_hsl : Color.Hsl -> Str
	format_hsl = |c| Str.concat(Str.concat(Str.concat(Str.concat(Str.concat(Str.concat("hsl(", I64.to_str(c.ch)), ","), I64.to_str(c.cs)), ","), I64.to_str(c.cl)), ")")

	format_hex_color : Color.Rgb -> Str
	format_hex_color = |c| Str.concat(Str.concat(Str.concat("#", col_hex2(c.cr)), col_hex2(c.cg)), col_hex2(c.cb))

	col_hex2 : I64 -> Str
	col_hex2 = |v| Str.concat(col_hex_digit(I64.div_trunc_by(v, 16)), col_hex_digit(I64.bitwise_and(v, 15)))

	col_hex_digit : I64 -> Str
