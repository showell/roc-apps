...
main! = |args| {
	...
	cap = 1000
	results = List.map_with_index(List.repeat(0, n), |_, i| GreedyRace.red_turns(tables, i + 1, cap))
	...
	echo!("red's base bonus ${I64.to_str(bonus)} a step: B4 is ${I64.to_str(List.get(red, Agent.index_of(GreedyRace.colors, { zone: NormalColor("red"), id: "B4" })) ?? -1)}\n")
