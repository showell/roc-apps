...
cp "$HERE/../roc/"{Machine,MachineApic,MachineCaps,MachineE1000,MachineGpu,MachineHpet,MachineIde,MachineMedia,MachineMem,MachineNat,MachineNe2k,MachinePci,MachinePorts,MachineScreen,MachineWire}.roc "$d/"
