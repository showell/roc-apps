...
ln -sf "$PWD/safari-web.service" "$PWD/safari-web-next.service" "$PWD/gallery-web.service" ~/.config/systemd/user/
systemctl --user daemon-reload
systemctl --user enable --now safari-web safari-web-next gallery-web
systemctl --user --no-pager status safari-web safari-web-next gallery-web | grep -E "service -|Active"
