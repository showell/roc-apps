...
Font :: [].{
	...
	strokes_for = |b|
		...
		else if b == 124 { [[2.0, 0.0, 2.0, 6.0]] } # |
		else if b == 37 { [[0.0, 6.0, 4.0, 0.0], [0.4, 0.4, 1.6, 0.4, 1.6, 1.6, 0.4, 1.6, 0.4, 0.4], [2.4, 4.4, 3.6, 4.4, 3.6, 5.6, 2.4, 5.6, 2.4, 4.4]] } # %
		else if b == 44 { [[2.2, 5.4, 2.2, 6.0, 1.5, 7.2]] } # ,
