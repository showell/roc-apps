# T1 with the record cut to the written list, a List(U8) and the counter. 10,000 writes.
M : { num : List(F64), scr : List(U8), pc : U64 }
...
main! = |args| {
	...
	m0 = { num: List.repeat(0.0, size), scr: List.repeat(32.U8, 1000), pc: 0 }
