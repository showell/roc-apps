# T1 with the record cut to the written list, a List(Str) and the counter. 10,000 writes.
M : { num : List(F64), out : List(Str), pc : U64 }
...
main! = |args| {
	...
	m0 = { num: List.repeat(0.0, size), out: [], pc: 0 }
